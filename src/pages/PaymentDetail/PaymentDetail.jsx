      ...
      <IsPlanSelected>
        <HomeLayout>
          <div className="w-full grow bg-neutrals-400 font-lato flex flex-col">
            <Steps steps={["Planes y coberturas", "Resumen"]} currentStep={1} />
            <article className="flex flex-col justify-center items-center p-8 grow">
              <MainLayout style={{
                ...
                <h1 className="w-full font-bold text-[40px] text-center md:text-start">Resumen del seguro</h1>
                ...
                <WhiteCard className="w-full py-6 px-8">
                  ...
                  <span className="flex gap-2 items-center capitalize">
                    <UsersIcon />
                    <h2 className="font-bold">{user?.name} {user?.lastName}</h2>
                  </span>
